        ...
        return (
            ...
            <Form>
                ...
                <div className="text-center">
                  ...
                  {/* and now here is the button to use for depositing one quarter coin*/}
                ...
                {/* <br /> */}
                <div className="text-center">
                    {/* and now here is the button for depositing one dime coin */}
                  <Button variant="outline-secondary" name="dime" onClick={addToDeposit}>
                      Add Dime
                  </Button>
                  {/* and now here we have the button for depositing one nickel coin */}
